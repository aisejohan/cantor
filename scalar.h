...
#define sc_ui_add(a,b,c)	{mpz_add_ui(c,b,(long)a);mpz_mod(c,c,modulus);}

#define sc_sub(a,b,c)		{mpz_sub(c,a,b);mpz_mod(c,c,modulus);}
...
#define sc_negate(a,b)		{mpz_neg(b,a);mpz_mod(b,b,modulus);}
